<!DOCTYPE html>
<?php
	if(isset($_POST["nome"]) && isset($_POST["endereco"]) && isset($_POST["datanascimento"]) && isset($_POST["depto"]))
	{
		$nome = $_POST["nome"];
...
<html lang="pt-br">
	...
	<body>
		...
		<div class="container-xll">
			...
			<!--Article-->
			<article>
				<div class="container-xll article-bg">
					<div class="card shadow">
						<div class="card-body row">
							<div class="col-sm-12 col-md-6">
								<h5 class="card-title text-center"><b>Dados do Gerente Cadastrado</b></h5>
								<?php
									echo "<br>\n";
									echo "\t\t\t\t\t\t<br>\n";
									echo "\t\t\t\t\t\t<br>\n";
									echo "\t\t\t\t\t\t<p class=\"dados\">Nome: $nome</p>\n";
									echo "\t\t\t\t\t\t<br>\n";
									echo "\t\t\t\t\t\t<p class=\"dados\">Endereço: $endereco</p>\n";
									echo "\t\t\t\t\t\t<br>\n";
									echo "\t\t\t\t\t\t<p class=\"dados\">Data de nascimento: $datanasc</p>\n";
									echo "\t\t\t\t\t\t<br>\n";
									echo "\t\t\t\t\t\t<p class=\"dados\">Departamento: $depto</p>\n";
									echo "\t\t\t\t\t\t<br>\n";
								?>
							</div>
							<div class="col-sm-12 col-md-6 position-relative text-center">
								<img src="img/dados/img8.jpeg" alt="Equipe Apple">
								<h5 class="title-img position-absolute top-0 start-50 translate-middle-x">Bem Vindo a equipe Apple</h5>
							</div>
						</div>
					</div>
				</div>
